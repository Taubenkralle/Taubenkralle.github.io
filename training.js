(() => {
  ...
  const LOGIC_DT = 1 / 30;
  const MAX_SHOTS = 240;
  const DIFF_HP_MULT = 1.6;
  const DIFF_SPEED_MULT = 1.28;
  const DIFF_LATE_HP_MULT = 1.45;
  const DIFF_LATE_SPEED_MULT = 1.22;
  ...
  function getSprite(kind){
    ...
    if (kind === "tower-dock"){
      rect(6, 22, 20, 6, dark);
      rect(8, 14, 16, 10, mid);
      rect(10, 10, 12, 6, light);
      rect(14, 7, 4, 4, glow2);
      rect(13, 18, 6, 4, glow);
      stroke(6, 13, 20, 15, outline);
      stroke(8, 21, 16, 7, outline);
    }else if (kind === "tower-emp"){
      rect(6, 20, 20, 6, dark);
      rect(8, 10, 16, 12, "#0b2b3a");
      rect(10, 12, 12, 8, glow2);
      rect(14, 6, 4, 4, cyan);
      rect(4, 14, 4, 4, cyan);
      rect(24, 14, 4, 4, cyan);
      stroke(7, 9, 18, 14, "#2a6d7c");
      stroke(6, 19, 20, 7, outline);
    }else if (kind === "tower-rail"){
      rect(6, 22, 20, 6, dark);
      rect(8, 14, 16, 8, "#0f2a3a");
      rect(10, 12, 12, 4, "#7fb0ff");
      rect(14, 6, 4, 8, cyan);
      rect(13, 18, 6, 3, cyan);
      stroke(7, 13, 18, 10, "#375c86");
      stroke(6, 21, 20, 7, outline);
    }else if (kind === "sentinel"){
      rect(8, 12, 16, 10, dark);
      rect(6, 14, 4, 6, mid);
      rect(22, 14, 4, 6, mid);
      rect(11, 13, 10, 6, glow);
      rect(14, 10, 4, 3, glow2);
      rect(14, 19, 4, 2, glow2);
      stroke(7, 11, 18, 12, outline);
    }else if (kind === "sentinel-fast"){
      rect(9, 13, 14, 8, dark);
      rect(6, 14, 3, 6, mid);
      rect(23, 14, 3, 6, mid);
      rect(12, 14, 8, 4, glow2);
      rect(13, 12, 6, 2, glow);
      stroke(8, 12, 16, 10, outline);
    }else if (kind === "sentinel-tank"){
      rect(6, 11, 20, 12, dark);
      rect(8, 13, 16, 8, mid);
      rect(11, 14, 10, 6, glow);
      rect(12, 9, 8, 3, glow2);
      rect(10, 21, 12, 2, glow2);
      stroke(5, 10, 22, 14, outline);
    }else if (kind === "sentinel-shield"){
      rect(7, 12, 18, 10, dark);
      rect(10, 13, 12, 8, "#0e2f2e");
      rect(12, 14, 8, 6, glow2);
      rect(13, 11, 6, 2, cyan);
      rect(13, 21, 6, 2, cyan);
      stroke(6, 11, 20, 12, "#5ec2c2");
    }else if (kind === "sentinel-swarm"){
      rect(12, 14, 8, 4, dark);
      rect(13, 13, 6, 2, glow2);
      rect(13, 18, 6, 2, glow2);
      px(11, 16, glow2);
      px(20, 16, glow2);
    }else if (kind === "sentinel-regen"){
      rect(7, 12, 18, 10, dark);
      rect(10, 14, 12, 6, "#113528");
      rect(12, 15, 8, 4, "#5bffb3");
      rect(13, 11, 6, 2, glow2);
      rect(13, 21, 6, 2, glow2);
      rect(14, 17, 4, 2, "#89ffcc");
      stroke(6, 11, 20, 12, outline);
    }else if (kind === "sentinel-boss"){
      rect(4, 10, 24, 14, dark);
      rect(7, 12, 18, 10, "#0a2621");
      rect(10, 14, 12, 6, "#b6ffea");
      rect(12, 11, 8, 2, cyan);
      rect(12, 22, 8, 2, cyan);
      rect(9, 8, 14, 2, glow2);
      stroke(3, 9, 26, 16, cyan);
    }
